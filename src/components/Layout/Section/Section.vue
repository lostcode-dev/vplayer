<template>
    <section style="height: calc(100vh - 3.5rem);" class="max-w-5xl flex justify-center items-center pt-3 mx-[auto]" >
        <div>
            ...
            <div class="flex justify-center mt-6">
                <button class="rounded-lg text-2xl px-14 py-3  bg-gradient-to-r from-teal-500 to-emerald-500 font-semibold text-white" >
