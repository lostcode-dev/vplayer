  ...
  >
    <div class="max-w-[50%] pr-8 flex flex-col self-center">
      ...
      <p class="text-justify mb-2">
        ...
        egestas non, auctor ut orci. Vivamus in iaculis lectus. Suspendisse sed urna in massa
      ...
      <button
        class="rounded-lg text-2xl px-14 py-2 bg-emerald-500 font-semibold text-white mt-6 self-center"
      >
        Ver Planos
      </button>
    </div>
